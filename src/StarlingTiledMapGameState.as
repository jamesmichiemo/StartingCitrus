package 
{
	...
	public class StarlingTiledMapGameState extends StarlingState {
		...
		[Embed(source="assets/map-atlas.tmx", mimeType="application/octet-stream")]
		private const _Map:Class;

		[Embed(source="assets/Genetica-tiles-atlas.xml", mimeType="application/octet-stream")]
		private const _MapAtlasConfig:Class;

		[Embed(source="assets/Genetica-tiles-atlas.png")]
